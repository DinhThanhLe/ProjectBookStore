...
<html class="no-js" lang="en">
    ...
    <body class="product-details">
        ...
        <header>
            ...
            <p>materialList: ${materialList}</p>
            <p>languageList: ${languageList}</p>
            <p>variantList: ${variantList}</p>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-6 col-12">
                                        <div class="flexslider">
                                            <ul class="slides">
                                                <li data-thumb="<%= request.getContextPath() %>/img/flex/1.jpg">
                                                <img src="<%= request.getContextPath() %>/img/flex/1.jpg" alt="woman" />
                                            </li>
                                            <li data-thumb="<%= request.getContextPath() %>/img/flex/5.jpg">
                                                <img src="<%= request.getContextPath() %>/img/flex/5.jpg" alt="woman" />
                                            </li>
                                            <li data-thumb="<%= request.getContextPath() %>/img/flex/2.jpg">
                                                <img src="<%= request.getContextPath() %>/img/flex/2.jpg" alt="woman" />
                                            </li>
                                    ...
                                    <div class="product-info-main">
                                        ...
                                        <div class="product-info-price">
                                            <div >
                                                ...
                                                <div>Giá: <span id="priceDisplay"></span></div>
                                                    ...
                                                    <c:forEach var="v" items="${variantList}" varStatus="status">
    {
                                            ...
                                            function updatePrice() {
                                                ...
                                                document.getElementById('priceDisplay').innerText = found ? found.price : 'Không có giá';
                                            }
